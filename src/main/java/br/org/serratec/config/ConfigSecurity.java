...
public class ConfigSecurity extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET, "/usuario", "/perfil","/cliente", "/categoria", "/endereco", "/pedido").hasAuthority("ADMIN")
	   	.antMatchers(HttpMethod.POST, "/usuario", "/perfil","/cliente", "/categoria", "/endereco", "/pedido").hasAuthority("ADMIN")
