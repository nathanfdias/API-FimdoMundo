...
public class ConfigSecurity extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET, "/usuarios", "/perfil","/clientes", "/categorias", "/pedidos", "/itempedidos", "/relatorio").hasAuthority("ADMIN")
	   	.antMatchers(HttpMethod.POST, "/usuarios", "/perfil","/clientes", "/categorias", "/pedidos", "/itempedidos", "/relatorio").hasAuthority("ADMIN")
...
// 		.antMatchers("/").permitAll()
// 		.antMatchers(HttpMethod.GET, "/produtos").permitAll()
// 		.antMatchers(HttpMethod.GET, "/usuarios", "/perfil","/clientes", "/categorias", "/pedidos", "/itemPedido").hasAuthority("ADMIN")
// 	   	.antMatchers(HttpMethod.POST, "/usuarios", "/perfil","/clientes", "/categorias", "/pedidos", "/itemPedido").hasAuthority("ADMIN")
// 		.anyRequest().authenticated()
// 		.and()
// 		.httpBasic()
// 		.and()
