...
public class ConfigSecurity extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET, "/usuario", "/perfil","/clientes", "/categorias", "/pedidos", "/itempedidos", "/relatorio").hasAuthority("ADMIN")
	   	.antMatchers(HttpMethod.POST, "/usuario", "/perfil","/clientes", "/categorias", "/pedidos", "/itempedidos", "/relatorio").hasAuthority("ADMIN")
