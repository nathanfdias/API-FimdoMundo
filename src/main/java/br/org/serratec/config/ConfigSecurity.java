...
public class ConfigSecurity extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET, "/usuarios", "/perfil","/clientes", "/categorias", "/pedidos", "/itempedidos").hasAuthority("ADMIN")
	   	.antMatchers(HttpMethod.POST, "/usuarios", "/perfil","/clientes", "/categorias", "/pedidos", "/itempedidos").hasAuthority("ADMIN")
